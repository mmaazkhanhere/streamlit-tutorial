# We have to import pydub python library which allow us to play or work with
# audio files in python

# pip install pydub

# We will also use FFmpeg library that have lots of sublibraries regarding
# to audio processing. You have to download as well as install the 
# python library

# pip install ffmpeg

# also install pyaudio using pip install pyaudio
